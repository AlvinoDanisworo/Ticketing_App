    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <aside class="lg:col-span-1">
        <div class="card sticky top-24 p-4 bg-base-100 shadow">
          ...
          @auth
            <button id="checkoutButton" class="btn btn-block mt-6 transition-colors" onclick="openCheckout()" disabled>Checkout</button>
          @else
  ...
  <script>
    ...
    function updateSummary() {
      ...
      if (totalQty === 0) {
        ...
        checkoutButton.classList.remove('btn-primary', '!bg-blue-900', 'text-white');
        checkoutButton.classList.add('btn-disabled', 'bg-gray-300', 'text-gray-500');
      } else {
        checkoutButton.disabled = false;
        checkoutButton.classList.remove('btn-disabled', 'bg-gray-300', 'text-gray-500');
        checkoutButton.classList.add('btn-primary', '!bg-blue-900', 'text-white');
      }
    }
